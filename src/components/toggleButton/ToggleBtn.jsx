...
const ToggleBtn = () => {
  ...
  const {theme, setTheme} = useModeContext();
      ...
      <label className="relative inline-flex cursor-pointer select-none items-center">
        ...
        <span
          className={`slider mx-4 flex h-8 w-[60px] items-center rounded-full p-1 duration-200 ${
            isChecked && theme ? "bg-[#212b36]" : "bg-yellow-300"
          }`}
        >
          <span
            className={`dot h-6 w-6 rounded-full bg-customBlue duration-200 flex justify-center items-center ${
              isChecked && theme ? "translate-x-[28px]" : ""
            }`}
          >
            {!isChecked && !theme ? (
              <svg
